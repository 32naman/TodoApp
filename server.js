...
var PORT = 8000;
var CLIENT_ID = "54565130306-rtqs8i7h7ml06p4sq0tvgnk87i01dkaj.apps.googleusercontent.com";
                    ...
                    case 1:
                        ...
                        fs.readFile(pathname, function (err, data) {
                            if (err) {
                                //TODO
                                var empty = [];
                                fs.writeFile(userTodo, JSON.stringify(empty), "utf-8", function (err) {
                                    if (err) {
                                        // TODO
                                        console.log("Error writing JSON file");
                                        return;
                                ...
                                var files = fs
                                    ...
                                    .filter(function (fn) { return fn.startsWith(email); });
                                var postJSON = {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        link = "http://localhost:" + PORT + "/share?hash=" + mapTokenToLink[token];
                        res.send(link);
                        return [2 /*return*/];
                }
            });
